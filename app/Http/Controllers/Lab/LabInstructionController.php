...
class LabInstructionController extends Controller
{
    public function index()
    {
        ...
        return view('lab.instruksi.index', compact('instructions', 'user'));
    }
    ...
    public function show($id)
    {
        ...
        return view('lab.instruksi.detail', compact('instruction', 'user'));
    }

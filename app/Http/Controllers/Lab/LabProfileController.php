...
class LabProfileController extends Controller
{
    public function show()
    {
        ...
        return view('lab.profil.show', compact('user', 'fotoPath'));
    }
    ...
    public function edit()
    {
        ...
        return view('lab.profil.edit', compact('user', 'fotoPath'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('lab.profil')->with('success', 'Profil berhasil diperbarui.');
    }
}

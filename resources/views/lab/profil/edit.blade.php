...
<body>
    ...
    <main class="profile-container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('lab.profil.update') }}" enctype="multipart/form-data">
                @csrf
               ...
               <div class="button-group">
                    <button type="button" class="btn-cancel" onclick="window.location='{{ route('lab.profil') }}'">Kembali</button>
